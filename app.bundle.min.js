...
function SrtTranslatorTool({ nativeLang, targetOrder, aiSettings, uiLang }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: boxStyle }, /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: () => setOpen((o) => !o),
    ...
    /* @__PURE__ */ React.createElement("span", { style: { fontSize: 14, fontWeight: 600, color: colors.ink } }, "ترجمه‌ی زیرنویس (SRT)"),
    open ? /* @__PURE__ */ React.createElement(ChevronUp, { size: 18, color: colors.inkSoft }) : /* @__PURE__ */ React.createElement(ChevronDown, { size: 18, color: colors.inkSoft })
  ), open && /* @__PURE__ */ React.createElement("div", { style: { marginTop: 10 } }, /* @__PURE__ */ React.createElement("p", { style: { fontSize: 12, color: colors.inkSoft, marginBottom: 8 } }, "یه فایلِ srt وارد کن، زبانِ مقصد رو انتخاب کن، ترجمه کن و فایلِ srtِ ترجمه‌شده رو دانلود کن — برای استفاده تو هر پلیرِ ویدیو/صوتِ دیگه."), /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 flex-wrap" }, /* @__PURE__ */ React.createElement(
    "input",
    {
      ref: fileInputRef,
      type: "file",
    ...
    "انتخابِ فایل srt"
  ), fileName && /* @__PURE__ */ React.createElement("span", { style: { fontSize: 12, color: colors.inkSoft } }, fileName, " (", toFaDigits(String(entries.length)), " خط)")), entries.length > 0 && /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2 flex-wrap", style: { marginTop: 10 } }, /* @__PURE__ */ React.createElement(
    "select",
    {
      value: targetLang,
      onChange: (e) => {
    ...
    langOptions.map((l) => /* @__PURE__ */ React.createElement("option", { key: l.code, value: l.code }, l.label))
  ), !translating ? /* @__PURE__ */ React.createElement(
    "button",
    {
    ...
    "توقف (",
    toFaDigits(String(progress.done)),
    "/",
    toFaDigits(String(progress.total)),
    ")"
  ), translatedEntries && !translating && /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: download,
  ...
  )), error && /* @__PURE__ */ React.createElement("p", { style: { fontSize: 12, color: colors.rose, marginTop: 8 } }, error)));
}
...
async function fetchWithTimeout(url, options = {}, timeoutMs = 4e3) {
...
const TRANSLATE_HARD_TIMEOUT_MS = 15e3;
...
` + ssml
  ...
  function sanitizeForTTS(s) {
    const KEEP_PUNCT = ".,!?;:،؛؟…";
    return String(s || "").replace(/[\u2066-\u2069\u200B-\u200F\u061C\uFEFF]/g, "").replace(/[\p{Extended_Pictographic}\u{1F1E6}-\u{1F1FF}\u{1F3FB}-\u{1F3FF}\u20E3\uFE0F]/gu, "").replace(/[«»‹›„‟""'''`´"']/g, "").replace(/[*_~]/g, "").replace(/[\p{P}\p{S}]/gu, (ch) => KEEP_PUNCT.includes(ch) ? ch : " ").replace(/\s+/g, " ").trim();
  }
  ...
  function speakChunk(idx, forceRestart = false, isRepeatContinuation = false) {
    ...
    utter.onend = () => {
      ...
      if (!singleShot) {
        ...
        const repeatTarget = globalRepeatSetting === "inf" ? isMultiChunk ? CHUNK_REPEAT_INFINITE_CAP : Infinity : Math.max(0, (Number(globalRepeatSetting) || 0) - 1);
  ...
  const controller = {
    ...
    toggle(text, code, startCharOffset, options) {
      try {
        ...
        const ONLINE_ONLY_LANGS = /* @__PURE__ */ new Set(["fa", "ar"]);
...
async function callAI({ prompt, maxTokens, retries = 2, aiSettings }) {
  ...
  for (let attempt = 0; ; attempt++) {
    try {
      ...
      const aiTimer = setTimeout(() => aiController.abort(), 1e4);
      let res;
      try {
...
function detectTextCEFRLevel(text) {
  ...
  const score = avgSentenceLen * 1 + avgWordLen * 3 + longWordRatio * 40 + uniqueRatio * 15;
...
function MuteButton({ color }) {
  ...
  return /* @__PURE__ */ React.createElement(
    "button",
    {
      ...
      title: muted ? "صدا خاموشه — پخش و هایلایت عادی ادامه داره؛ بزن روشنش کن" : "بی‌صداکردنِ صدایِ خوانش — برایِ وقتی نرم‌افزارِ دیگه‌ای صدایِ خودش رو داره",
      style: {
        flexShrink: 0,
        display: "flex",
        alignItems: "center",
    ...
    muted ? /* @__PURE__ */ React.createElement(VolumeX, { size: 15 }) : /* @__PURE__ */ React.createElement(Volume2, { size: 15 })
  );
}
...
function StoryUserAudioBar({ userAudio, playbackMode, setPlaybackMode }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: boxStyle }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between gap-2 flex-wrap" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-1", style: { border: `1px solid ${colors.cardBorder}`, borderRadius: 20, padding: 2 } }, /* @__PURE__ */ React.createElement(
    "button",
    {
    ...
    "صوت من"
  )), !hasAudio ? /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
    "input",
    {
      ref: fileInputRef,
      type: "file",
    ...
    "حذف صوت"
  )), hasAudio && playbackMode === "user" && /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-2", style: { marginTop: 10 } }, /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: prevLine,
      title: "جمله‌ی قبل",
    ...
    /* @__PURE__ */ React.createElement(SkipBack, { size: 18 })
  ), /* @__PURE__ */ React.createElement(
    "button",
    {
    ...
    isPlaying ? /* @__PURE__ */ React.createElement(Pause, { size: 16 }) : /* @__PURE__ */ React.createElement(PlayCircle, { size: 18 })
  ), /* @__PURE__ */ React.createElement(
    "button",
    {
      onClick: nextLine,
    ...
    /* @__PURE__ */ React.createElement(SkipForward, { size: 18 })
  ), /* @__PURE__ */ React.createElement(
    "input",
    {
      type: "range",
  ...
  ), /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: colors.inkSoft, flexShrink: 0 } }, fmtTime(currentTime), " / ", fmtTime(duration))));
}
function StoryBuilder({ nativeLang, nativeLabel, targetOrder, wordStats, setWordStats, savedStories, setSavedStories, aiSettings, jumpTo, onFullTextChange, autoScrollActive, calendarSystem, highlightColor, uid, uiLang }) {
  ...
  const [playbackMode, setPlaybackMode] = useState("tts");
  useEffect(() => {
  ...
  useEffect(() => {
    ...
    const node = granularity === "sentence" ? sentenceElsRef.current[`${sentenceForScroll.pi}-${sentenceForScroll.si}`] : paragraphElsRef.current[sentenceForScroll.pi];
    if (node && node.scrollIntoView) {
      node.scrollIntoView({ behavior: "smooth", block: "center" });
    }
...
Rewrite ONLY the "paragraph to rewrite" so it stays fully coherent with the previous/next paragraphs and keeps roughly the same length and tone, but adjusts these word counts (counting all grammatical forms/inflections together): ${needsList}. Weave the words naturally into the sentences — don't just repeat them mechanically or list them. Respond ONLY with strict JSON, no markdown fences, no extra text: {"sentences": [{"text": "..."}]}`;
  ...
  const handlePdfImportForReading = async (e) => {
    ...
    try {
      ...
      const fullRawText = allSentences2.join(" ");
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "flex flex-col gap-4" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between" }, /* @__PURE__ */ React.createElement("p", { style: { fontWeight: 700, fontSize: 16 } }, "داستان‌ساز"), /* @__PURE__ */ React.createElement("div", { className: "flex gap-2" }, /* @__PURE__ */ React.createElement(
    ...
    savedStories.length,
    ")"
  ))), /* @__PURE__ */ React.createElement(SrtTranslatorTool, { nativeLang, targetOrder, aiSettings, uiLang }), showSaved ? /* @__PURE__ */ React.createElement("div", { className: "flex flex-col gap-3" }, /* @__PURE__ */ React.createElement(LevelFilterRow, { levelFilter: savedStoriesLevelFilter, setLevelFilter: setSavedStoriesLevelFilter, uiLang }), savedStories.length > 1 && /* @__PURE__ */ React.createElement("div", { className: "flex justify-start" }, /* @__PURE__ */ React.createElement(SavedStoriesSortMenu, { sortKey: savedStoriesSort, setSortKey: setSavedStoriesSort })), savedStories.length === 0 && /* @__PURE__ */ React.createElement("p", { style: { fontSize: 13, color: colors.inkSoft } }, "هنوز داستانی ذخیره نکردی."), savedStories.length > 0 && (() => {
    const groups = (savedStoriesLevelFilter !== "all" ? [[savedStoriesLevelFilter, savedStories.filter((s) => s.storyLevel === savedStoriesLevelFilter)]] : [["all", savedStories]]).map(([lv, list]) => [lv, sortSavedStories(list, savedStoriesSort)]);
    ...
    return groups.map(([lv, list]) => /* @__PURE__ */ React.createElement("div", { key: lv, className: "flex flex-col gap-2" }, list.map((s) => /* @__PURE__ */ React.createElement(
      "div",
      {
        key: s.id,
    ...
    fullStoryText && /* @__PURE__ */ React.createElement(
      StoryUserAudioBar,
      {
        userAudio,
        playbackMode,
    ...
    /* @__PURE__ */ React.createElement("div", { className: "flex flex-col gap-5" }, paragraphs.map((p, pi) => {
      ...
      return /* @__PURE__ */ React.createElement("div", { key: pi, style: { borderBottom: pi < paragraphs.length - 1 ? `1px dashed ${colors.cardBorder}` : "none", paddingBottom: 14 } }, granularity === "sentence" ? /* @__PURE__ */ React.createElement("div", { className: "flex flex-col gap-3" }, (p.sentences || []).map((s, si) => {
        const isSentenceActive = highlightSentence && highlightSentence.pi === pi && highlightSentence.si === si || (playbackMode === "user" ? userAudio.activeSentence && userAudio.activeSentence.pi === pi && userAudio.activeSentence.si === si : activeStorySentence && activeStorySentence.pi === pi && activeStorySentence.si === si);
        return /* @__PURE__ */ React.createElement(
          "div",
          {
            key: si,
        ...
        (() => {
          const isParaActive = highlightSentence && highlightSentence.pi === pi || (playbackMode === "user" ? userAudio.activeSentence && userAudio.activeSentence.pi === pi : activeStorySentence && activeStorySentence.pi === pi);
...
function PhrasebookMain({ user, onLogout, appPrefs, setAppPrefs }) {
  ...
  if (!loaded) {
    return /* @__PURE__ */ React.createElement(
      ...
      "در حال بارگذاری...",
      loadTimedOut && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement("p", { style: { fontSize: 12.5, maxWidth: 320 } }, "بارگذاری بیش از حدِ معمول طول کشید. اگه دکمه‌ی پایین رو بزنی، برنامه بدونِ نسخه‌ی ذخیره‌شده‌ی محلی باز می‌شه (داده‌ی ابری هنوز در پس‌زمینه لود می‌شه)."), /* @__PURE__ */ React.createElement(
        "button",
        {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    (tab === "conversations" || tab === "words" || tab === "favorites" || tab === "vocab" || tab === "slang") && /* @__PURE__ */ React.createElement("div", { className: "px-4 pt-3" }, /* @__PURE__ */ React.createElement(LevelFilterRow, { levelFilter, setLevelFilter, uiLang: appPrefs.uiLang })),
    ...
    showPlayerBar && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "px-4", style: { paddingTop: 2, paddingBottom: 6, display: "flex", alignItems: "center", justifyContent: "space-around" } }, /* @__PURE__ */ React.createElement(MuteButton, { color: colors.gold }), /* @__PURE__ */ React.createElement(RepeatButton, { color: colors.gold }), /* @__PURE__ */ React.createElement(RestartButton, { color: colors.gold, startText: activeTabAudio?.text, startCode: activeTabAudio?.code }), /* @__PURE__ */ React.createElement(ChunkNavButton, { direction: "prev", color: colors.ink }), /* @__PURE__ */ React.createElement(
        MainPlayButton,
        {
      ...
      ), /* @__PURE__ */ React.createElement(ChunkNavButton, { direction: "next", color: colors.ink })),
      /* @__PURE__ */ React.createElement("div", { className: "px-4 flex items-center gap-2", style: { paddingTop: 2, paddingBottom: 8 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: colors.inkSoft, whiteSpace: "nowrap" } }, "شفافیت پلیر"), /* @__PURE__ */ React.createElement(
        "input",
        {
          type: "range",
          min: 0,
...
function App() {
  ...
  useEffect(() => {
    ...
    const t = setTimeout(() => setSessionTimedOut(true), 8e3);
    return () => clearTimeout(t);
  }, [checkingSession]);
  ...
  if (checkingSession && sessionTimedOut) {
    return /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("p", { style: { fontSize: 13, color: colors.inkSoft } }, "چکِ ورودِ حساب بیش از حدِ معمول طول کشید — احتمالاً مشکلِ اتصال یا سرور. می‌تونی صفحه‌ی ورود رو باز کنی و دوباره امتحان کنی."),
      /* @__PURE__ */ React.createElement(
        "button",
        {
...
function showFatalErrorOverlay(err) {
  try {
    ...
    if (!box) {
      ...
      box.style.cssText = "position:fixed;inset:0;z-index:99999;background:#fff3f3;color:#7a1f1f;direction:ltr;text-align:left;font-family:monospace;font-size:12px;padding:16px;overflow:auto;white-space:pre-wrap;line-height:1.5;";
