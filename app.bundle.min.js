  ...
  useEffect(() => {
    ...
    function playAt(i) {
      ...
      window.setTimeout(() => {
        ...
        speechController.toggle(item.text, item.code, void 0, singlePass ? { singlePass: true } : void 0);
      }, 450);
    }
...
function PhrasebookMain({ user, onLogout, appPrefs, setAppPrefs }) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    showPlayerBar && /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "px-4 pt-2 flex items-center gap-2 flex-wrap", style: { justifyContent: "flex-end", rowGap: 8 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: colors.inkSoft } }, "تکرار پخش"), /* @__PURE__ */ React.createElement(RepeatButton, { color: colors.gold }), tab === "story" && storyPlayerText.text && /* @__PURE__ */ React.createElement(SpeakButton, { text: storyPlayerText.text, code: storyPlayerText.code, color: colors.teal }), /* @__PURE__ */ React.createElement(SpeedControl, { color: colors.gold }), /* @__PURE__ */ React.createElement(AutoplayToggle, { enabled: autoScrollPlay, onToggle: () => setAutoScrollPlay((v) => !v), color: colors.teal })),
