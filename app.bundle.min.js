...
function MainPlayButton({ startText, startCode, resolveStartOffset, color, size, allowStoryAudio }) {
  ...
  if (useStoryAudio) {
    ...
    return /* @__PURE__ */ React.createElement(
      ...
      isPlaying2 ? /* @__PURE__ */ React.createElement(Pause, { size: btnSize2 }) : /* @__PURE__ */ React.createElement(PlayCircle, { size: btnSize2 })
    );
  }
  const isActive = state.status !== "idle" && !!state.key;
  const isPlaying = isActive && state.status === "playing";
...
function PlayerProgressTrack({ color, allowStoryAudio }) {
  ...
  const isActive = useStoryAudio ? audioState.hasAudio : state.status !== "idle" && !!state.key && state.total > 0;
  ...
  const totalMs = useStoryAudio ? (audioState.duration || 0) * 1e3 : fullLen * msPerChar;
  const chunkStart = !useStoryAudio && isActive && meta[state.chunkIndex] ? meta[state.chunkIndex].start : 0;
  const restPct = useStoryAudio ? audioState.duration ? audioState.currentTime / audioState.duration * 100 : 0 : fullLen ? chunkStart / fullLen * 100 : 0;
  ...
  ), /* @__PURE__ */ React.createElement("span", { style: { fontVariantNumeric: "tabular-nums", fontSize: 12, color: colors.inkSoft, minWidth: 36, textAlign: "center", flexShrink: 0 } }, isActive ? fmtTime(totalMs) : "۰۰:۰۰"), !useStoryAudio && /* @__PURE__ */ React.createElement(SpeedControl, { color: colors.gold }));
}
...
function StoryUserAudioBar({ userAudio, playbackMode, setPlaybackMode }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: boxStyle }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center justify-between gap-2 flex-wrap" }, /* @__PURE__ */ React.createElement("div", { className: "flex items-center gap-1", style: { border: `1px solid ${colors.cardBorder}`, borderRadius: 20, padding: 2 } }, /* @__PURE__ */ React.createElement(
    ...
    "حذف صوت"
  )), hasAudio && playbackMode === "user" && /* @__PURE__ */ React.createElement("p", { style: { fontSize: 11, color: colors.inkSoft, marginTop: 8 } }, "پخش/توقف و جمله‌ی قبل‌وبعد رو از پلیرِ پایینِ صفحه کنترل کن."));
}
...
function PhrasebookMain({ user, onLogout, appPrefs, setAppPrefs }) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    showPlayerBar && /* @__PURE__ */ React.createElement(React.Fragment, null, /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement(PlayerProgressTrack, { color: colors.gold, allowStoryAudio: tab === "story" }),
      /* @__PURE__ */ React.createElement("div", { className: "px-4", style: { paddingTop: 2, paddingBottom: 6, display: "flex", alignItems: "center", justifyContent: "space-around" } }, /* @__PURE__ */ React.createElement(MuteButton, { color: colors.gold }), /* @__PURE__ */ React.createElement(RepeatButton, { color: colors.gold }), /* @__PURE__ */ React.createElement(RestartButton, { color: colors.gold, startText: activeTabAudio?.text, startCode: activeTabAudio?.code, allowStoryAudio: tab === "story" }), /* @__PURE__ */ React.createElement(ChunkNavButton, { direction: "next", color: colors.ink, allowStoryAudio: tab === "story" }), /* @__PURE__ */ React.createElement(
        MainPlayButton,
        {
      ...
      ), /* @__PURE__ */ React.createElement(ChunkNavButton, { direction: "prev", color: colors.ink, allowStoryAudio: tab === "story" })),
