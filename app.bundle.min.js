    ...
    /* @__PURE__ */ React.createElement("div", { className: "flex flex-col gap-5" }, paragraphs.map((p, pi) => {
      ...
      return /* @__PURE__ */ React.createElement("div", { key: pi, style: { borderBottom: pi < paragraphs.length - 1 ? `1px dashed ${colors.cardBorder}` : "none", paddingBottom: 14 } }, granularity === "sentence" ? /* @__PURE__ */ React.createElement("div", { className: "flex flex-col gap-3" }, (p.sentences || []).map((s, si) => {
        ...
        "div",
        {
          ...
          style: activeStorySentence && activeStorySentence.pi === pi ? {
            backgroundColor: "#FFF6D9",
            borderRadius: 8,
            boxShadow: `inset 3px 0 0 ${colors.gold}`,
            padding: "4px 6px",
...
function PhrasebookMain({ user, onLogout, appPrefs, setAppPrefs }) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    showPlayerBar && /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "px-4 pt-2 flex items-center gap-2 flex-wrap", style: { justifyContent: "flex-end", rowGap: 8 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: colors.inkSoft } }, "تکرار پخش"), /* @__PURE__ */ React.createElement(RepeatButton, { color: colors.gold }), tab === "story" && storyPlayerText.text && /* @__PURE__ */ React.createElement(SpeakButton, { text: storyPlayerText.text, code: storyPlayerText.code, color: colors.teal, forceRepeat: true }), /* @__PURE__ */ React.createElement(SpeedControl, { color: colors.gold }), /* @__PURE__ */ React.createElement(AutoplayToggle, { enabled: autoScrollPlay, onToggle: () => setAutoScrollPlay((v) => !v), color: colors.teal })),
