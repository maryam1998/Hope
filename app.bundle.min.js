    ...
    /* @__PURE__ */ React.createElement("div", { className: "flex flex-col gap-5" }, paragraphs.map((p, pi) => {
      ...
      return /* @__PURE__ */ React.createElement("div", { key: pi, style: { borderBottom: pi < paragraphs.length - 1 ? `1px dashed ${colors.cardBorder}` : "none", paddingBottom: 14 } }, granularity === "sentence" ? /* @__PURE__ */ React.createElement("div", { className: "flex flex-col gap-3" }, (p.sentences || []).map((s, si) => {
        ...
        return /* @__PURE__ */ React.createElement(
          ...
          /* @__PURE__ */ React.createElement("div", { className: "flex items-start gap-2", dir: dirFor(storyLang) }, /* @__PURE__ */ React.createElement(SpeakButton, { text: s.text, code: storyLang, color: colors.inkSoft, edge: dirFor(storyLang) === "ltr" ? "end" : void 0 }), /* @__PURE__ */ React.createElement(
            "p",
            {
              style: {
        ...
        activeStorySentence && activeStorySentence.pi === pi && /* @__PURE__ */ React.createElement(
          "span",
          {
            style: {
              position: "absolute",
        ...
        /* @__PURE__ */ React.createElement("div", { className: "flex items-start gap-2", dir: dirFor(storyLang) }, /* @__PURE__ */ React.createElement(SpeakButton, { text: paragraphText, code: storyLang, color: colors.inkSoft, edge: dirFor(storyLang) === "ltr" ? "end" : void 0 }), /* @__PURE__ */ React.createElement(
          "p",
          {
            style: {
              fontFamily: RTL_LANGS.includes(storyLang) ? fontFa : fontLatin,
...
function PhrasebookMain({ user, onLogout, appPrefs, setAppPrefs }) {
  ...
  return /* @__PURE__ */ React.createElement(
    ...
    ), favoritedWords.length > 0 && /* @__PURE__ */ React.createElement("div", null, /* @__PURE__ */ React.createElement("h2", { style: { color: colors.gold, fontWeight: 700, fontSize: 13, marginBottom: 8 } }, "لغات"), /* @__PURE__ */ React.createElement(
      WordList,
      {
    ...
    showPlayerBar && /* @__PURE__ */ React.createElement(
      ...
      /* @__PURE__ */ React.createElement("div", { className: "px-4 pt-2 flex items-center gap-2 flex-wrap", style: { justifyContent: "flex-end", rowGap: 8 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: colors.inkSoft } }, "تکرار پخش"), /* @__PURE__ */ React.createElement(RepeatButton, { color: colors.gold }), tab === "story" && storyPlayerText.text && /* @__PURE__ */ React.createElement(SpeakButton, { text: storyPlayerText.text, code: storyPlayerText.code, color: colors.teal, forceRepeat: true }), tab === "conversations" && dailyPlayerText.text && /* @__PURE__ */ React.createElement(SpeakButton, { text: dailyPlayerText.text, code: dailyPlayerText.code, color: colors.teal, forceRepeat: true }), (tab === "words" || tab === "vocab" || tab === "daily") && wordListPlayerText.text && /* @__PURE__ */ React.createElement(SpeakButton, { text: wordListPlayerText.text, code: wordListPlayerText.code, color: colors.teal, forceRepeat: true }), /* @__PURE__ */ React.createElement(SpeedControl, { color: colors.gold }), /* @__PURE__ */ React.createElement(AutoplayToggle, { enabled: autoScrollPlay, onToggle: () => setAutoScrollPlay((v) => !v), color: colors.teal })),
      /* @__PURE__ */ React.createElement("div", { className: "px-4 flex items-center gap-2", style: { paddingTop: 4, paddingBottom: 8 } }, /* @__PURE__ */ React.createElement("span", { style: { fontSize: 11, color: colors.inkSoft, whiteSpace: "nowrap" } }, "شفافیت پلیر"), /* @__PURE__ */ React.createElement(
        "input",
        {
          type: "range",
          min: 0,
...
function WordList({ words, wordFavorites, toggleWordFavorite, query, levelFilter, emptyText, nativeLang, nativeLabel, targetLangs, aiSettings, autoplayEnabled, onFullTextChange, autoScrollActive, ClickableSentence: ClickableSentence2 }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "flex flex-col gap-2" }, visible.map((w) => /* @__PURE__ */ React.createElement(
    ...
    activeWordId === w.id && /* @__PURE__ */ React.createElement(
      "span",
      {
        style: {
          position: "absolute",
...
function WordTargetTranslation({ word, langCode, abbr, knownText, nativeLang, nativeLabel, aiSettings, ClickableSentence: ClickableSentence2 }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { style: { display: "flex", alignItems: "center", gap: 8, direction: "ltr" } }, /* @__PURE__ */ React.createElement(
    "span",
    {
      style: {
        fontFamily: fontFa,
    ...
    abbr
  ), text ? /* @__PURE__ */ React.createElement(React.Fragment, null, ClickableSentence2 ? /* @__PURE__ */ React.createElement("p", { style: { flex: 1, fontSize: 14, fontWeight: 700, color: colors.inkSoft } }, /* @__PURE__ */ React.createElement(
    ClickableSentence2,
    {
      text,
      langCode,
  ...
  )) : /* @__PURE__ */ React.createElement("p", { style: { flex: 1, fontSize: 14, fontWeight: 700, color: colors.inkSoft } }, text), /* @__PURE__ */ React.createElement(SpeakButton, { text, code: langCode, color: colors.teal, edge: "end" })) : /* @__PURE__ */ React.createElement("p", { style: { flex: 1, fontSize: 12, color: colors.inkSoft } }, "در حال ترجمه..."));
}
