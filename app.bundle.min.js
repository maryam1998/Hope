...
function toggleSavedStoryWord(word, langCode, opts) {
  ...
  if (idx >= 0) {
    ...
    list.unshift({ word: cleanWord || word, langCode, savedAt: (/* @__PURE__ */ new Date()).toISOString(), translations });
    nowSaved = true;
  }
  try {
...
function WordList({ words, wordFavorites, toggleWordFavorite, query, levelFilter, emptyText, nativeLang, targetLangs, aiSettings, autoplayEnabled }) {
  ...
  return /* @__PURE__ */ React.createElement("div", { className: "flex flex-col gap-2" }, visible.map((w) => /* @__PURE__ */ React.createElement(
    ...
    ), /* @__PURE__ */ React.createElement(SpeakButton, { text: w.en, code: "en", color: colors.teal }), /* @__PURE__ */ React.createElement(LevelBadge, { level: w.level }), /* @__PURE__ */ React.createElement(
      "span",
      {
        style: {
          fontFamily: fontFa,
